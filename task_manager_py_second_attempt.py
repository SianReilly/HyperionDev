...
def add_task(task_list, username_password):
    ...
    # Update tasks.txt file with the new task
...
def display_statistics(task_list, username_password):
    ...
    # Display task overview report
    with open("task_overview.txt", "r") as task_overview_file:
        print(task_overview_file.read())

    # Display user overview report
...
def main():
    ...
    while True:
        ...
        : ''').lower()
        if menu == 'r':
            reg_user(username_password)  # Call function to register user
        elif menu == 'a':
            add_task(task_list, username_password)  # Call function to add task
        elif menu == 'va':
            view_all(task_list)  # Call function to view all tasks
        elif menu == 'vm':
            view_mine(task_list, curr_user)  # Call function to view tasks assigned to the current user
        elif menu == 'gr':
